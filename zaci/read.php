...
$stmt = $pdo->prepare('SELECT * FROM accounts WHERE zskola=:zskola ORDER BY id LIMIT :current_page, :record_per_page');
$stmt->bindValue(':zskola', $_SESSION['name'], PDO::PARAM_INT);
